...
[BuildOptions]
  ...
  GCC:*_*_IA32_DLINK2_FLAGS = -lgcc -Wl,--no-warn-mismatch
  GCC:RELEASE_*_*_CC_FLAGS = -DEDK2_TARGET_RELEASE
  GCC:DEBUG_*_*_CC_FLAGS = -DEDK2_TARGET_DEBUG
  GCC:NOOPT_*_*_CC_FLAGS = -DEDK2_TARGET_NOOPT
  GCC:*_*_*_CC_FLAGS = -DEMBLOADER_VERSION=\"$(EMBLOADER_VERSION)\"
  GCC:NOOPT_GCC5_AARCH64_OBJCOPY_PATH = $(GCC5_AARCH64_PREFIX)objcopy
  GCC:NOOPT_GCC5_AARCH64_OBJCOPY_FLAGS =
