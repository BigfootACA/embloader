...
#define LV_STDARG_INCLUDE       <stdarg.h>
	...
	#define LV_MEM_POOL_INCLUDE <Library/MemoryAllocationLib.h>
	#define LV_MEM_POOL_ALLOC AllocatePool
    #endif
...
#define LV_DRAW_BUF_ALIGN                       sizeof(void*)
...
#define LV_IMAGE_HEADER_CACHE_DEF_CNT 256
...
#if LV_USE_FS_UEFI
    #define LV_FS_UEFI_LETTER 'C'      /**< Set an upper-case driver-identifier letter for this driver (e.g. 'A'). */
#endif
...
#if LV_USE_UEFI
    #define LV_USE_UEFI_INCLUDE <src/drivers/uefi/lv_uefi_edk2.h>   /**< Header that hides the actual framework (EDK2, gnu-efi, ...) */
