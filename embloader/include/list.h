...
extern int list_remove_free(list* point, int (*datafree)(void*));

// src/lib/list.c: free an item
extern int list_free_item(list* point, int (*datafree)(void*));

// src/lib/list.c: free all items in list
extern int list_free_all(list* point, int (*datafree)(void*));

// src/lib/list.c: free all items in list from last to first
extern int list_free_all_reverse(list* point, int (*datafree)(void*));
...
extern int list_obj_del(list** lst, list* item, int (*datafree)(void*));

// src/lib/list.c: lookup item and delete from a list
extern int list_obj_del_data(list** lst, void* data, int (*datafree)(void*));
...
// src/lib/list.c: convert list to string with separator
extern char* list_to_string(list* lst, char* sep);

static inline void* _memdup(const void* data, size_t len) {
...
#define _DECLARE_X_DUP(_name,_ret,_arg,_ifs,...) \
	_DECLARE_DUP(_name##_dup,_name##_notnull,_ret,_memdup(data,len),_arg,_ifs,__VA_ARGS__ void*data,size_t len)\
...
#define LIST_DATA(_list,_type)((_type)(((list*)(_list))->data))
